...
func get_artwork_path() -> String:
	...
	elif "vô trung" in n or "sinh hữu" in n: return "res://assets/ui/cards/card_ex_nihilo.png"
	elif "qua cầu" in n or "rút ván" in n: return "res://assets/ui/cards/card_dismantle.png"
	elif "thuận thủ" in n or "dắt dê" in n: return "res://assets/ui/cards/card_snatch.png"
	elif "sấm sét" in n: return "res://assets/ui/cards/card_lightning.png"
